...
<h4>Configuración de cuenta
	
</h3>

 
<p>
	Por si buscabas ingresar una cuenta este sitio web no es para que te registres es ver y comprar los productos que te ofrecemos y puedas adquirirlos en el lugar donde se encuentra ubicado el negocio o atraves de este sitio.
</p>
<h4>
	Seguridad.
</h4>

	<p>	Si buscabas algún tipo de seguridad no te lo proporcionamos esto sería por si fuera entrega a domicilio pero como no tenemos eso no te proporcionamos seguridad 
		ya que solo vendrías a comprar hasta el negocio.

	</p>


<h4>¿No encuentras la información que buscabas?</h4>
<p>Escríbenos a  nuestras redes antes mencionadas y te responderemos al instante.</p>
