...
<html lang="es">
    ...
    <body>
        ...
        <section>
            <div class="container">
                <h4 class="center-align tittles">Videojuegos</h4>
                ...
                <div id="products" class="row list-group">
                    ...
                    foreach ($coleccion as $obj) {
                        if ($obj->categoria == "videojuegos") {
                            ?>
                            <div class="item  col-xs-4 col-lg-4">
                                <div class="thumbnail">
                                    <a href='articulo.php?id=<?php echo $obj->_id ?>'>
                                    <img class="group list-group-image" src="imagenes/productos/<?php echo $obj->imagen ?>" alt=""/>
                                    </a>
                                    <div class="caption">
